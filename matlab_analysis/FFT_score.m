...
%input: 
%signal
%length_trh - threshold for the legth of trace to calculate score
%int - interval for the noisevalue calculation
%Tacq - duration of one frame in sec

%output:
%score_FFT - ratio between 25 Hz band and the std of the noise taken from the window determined by int 
